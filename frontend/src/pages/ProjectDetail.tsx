    ...
    <div className="flex flex-col pb-12">
      <div className="container mx-auto px-4 lg:px-6 pt-6">
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="mb-6">
          <TabsList className={`grid h-12 w-full glass-card p-1 rounded-xl shadow-inner ${canChat ? 'grid-cols-4' : (project.status === 'open' && !isHost && !isAcceptedContributor) ? 'grid-cols-3' : 'grid-cols-2'
            }`}>
