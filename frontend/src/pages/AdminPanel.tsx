  ...
  return (
    <div className="container max-w-6xl mx-auto py-8 px-4">
      ...
      <Alert className="mb-6 border-orange-500 bg-orange-50 dark:bg-orange-950/20">
        ...
        <AlertTitle className="text-orange-600">Admin Actions</AlertTitle>
      ...
      <Tabs defaultValue="overview" className="space-y-6">
            ...
            <CardContent>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div className="p-4 border rounded-lg">
                  ...
                  <p className="text-sm text-muted-foreground">Flagged Projects</p>
                </div>
                <div className="p-4 border rounded-lg">
                  <p className="text-2xl font-bold">0</p>
                ...
                <div className="p-4 border rounded-lg">
                  <p className="text-2xl font-bold">0</p>
                  <p className="text-sm text-muted-foreground">Reversed Credits</p>
                </div>
              </div>
        ...
        <TabsContent value="projects">
          <Card>
            <CardHeader>
              <CardTitle>Moderate Projects</CardTitle>
              <CardDescription>
        ...
        <TabsContent value="contributions">
          <Card>
            <CardHeader>
              <CardTitle>Moderate Contributions</CardTitle>
              <CardDescription>
        ...
        <TabsContent value="users">
          <Card>
            <CardHeader>
              <CardTitle>Moderate Users</CardTitle>
              <CardDescription>
