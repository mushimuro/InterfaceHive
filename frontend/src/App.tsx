...
const Home = () => (
  <div className="flex items-center justify-center min-h-screen">
    <div className="text-center">
      <h1 className="text-4xl font-bold mb-4">Welcome to InterfaceHive</h1>
      <p className="text-muted-foreground">Platform for collaborative contributions</p>
      <div className="mt-6">
        <a href="/projects" className="text-primary hover:underline">Browse Projects →</a>
      </div>
    </div>
  </div>
);
